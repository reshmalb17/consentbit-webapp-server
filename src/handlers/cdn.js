...
! function () {
  ...
  function he(e) {
    if (e && "SCRIPT" === e.nodeName && (!e.getAttribute || "javascript/blocked" !== e.getAttribute("type"))) {
      ...
      if (t) {
        ...
        var ic = (e.getAttribute && (e.getAttribute("data-consentbit-category") || (!window.__CB_WEBFLOW_MODE__ && e.getAttribute("data-category")))) || Di(e.textContent || "");
        if (ic && !ue(ic)) try {
      ...
      try {
        ...
        if (tc && tc.set) {
          ...
          Object.defineProperty(e, "textContent", {
            ...
            set: function(val) {
              var cat = (e.getAttribute && (e.getAttribute("data-consentbit-category") || (!window.__CB_WEBFLOW_MODE__ && e.getAttribute("data-category")))) || Di(val);
              if (cat && !ue(cat)) {
                e.__ci = val;
                e.setAttribute("type", "javascript/blocked");
                e.setAttribute("data-cb-inline", "1");
  ...
  function ke(e) {
    if (window.__CB_WEBFLOW_MODE__) Ie(e || (A && A.categories) || {
      ...
      var fq = document.querySelectorAll('script[type="text/plain"][data-consentbit-category],script[type="text/plain"][data-category]');
      for (var gi = 0; gi < fq.length; gi++) {
        var hs = fq[gi];
        var ja = hs.getAttribute("data-consentbit-category") || hs.getAttribute("data-category");
        if (ja && cbCatsOk(ja)) {
          z = !0;
          try {
            ...
            for (var ua = 0; ua < qa.length; ua++) {
              var va = qa[ua].name;
              if (va !== "type" && va !== "src" && va !== "data-consentbit-category" && va !== "data-category") kq.setAttribute(va, qa[ua].value);
            }
      ...
      for (var xi = 0; xi < wq.length; xi++) {
        var ys = wq[xi];
        var zq = ys.__ci || "";
        var iq = (ys.getAttribute && (ys.getAttribute("data-consentbit-category") || ys.getAttribute("data-category"))) || Di(zq);
        if (iq && cbCatsOk(iq)) {
          z = !0;
          try {
