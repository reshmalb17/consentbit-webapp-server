...
(function () {
  ...
  // Use the same origin that served this embed script (prevents prod sites from depending
  // on a hardcoded dev host). Falls back to API_BASE when currentScript is unavailable.
...
\`;
  ...
  async function initAll() {
    ...
    if (!document.getElementById('consentBitBanner') || !document.getElementById('cbPreferenceModal')) {
      injectHTML();
    }
    blockNonEssentialScripts();
