...
async function _handleCDNScript(request, env, url) {
  ...
  if (customization) {
    ...
    var initialSize =
      'width:' + baseWidth + '!important;min-width:360px;max-width:min(' + maxWidth + ',96vw)!important;max-height:min(80vh,600px);min-height:160px;overflow:hidden;';
    var initialRadius = 'border-radius:' + bannerRadius + '!important;';
    if (layoutVisual === 'banner') {
      initialSize = 'width:auto!important;max-width:none!important;min-height:140px;';
    ...
    if (effectiveBannerType === 'ccpa' && layoutVisual !== 'banner') {
      ...
      initialSize = 'width:' + ccpaWidthPx + 'px!important;min-width:360px;max-width:min(' + ccpaWidthPx + 'px,96vw)!important;max-height:min(80vh,660px);min-height:200px;overflow:hidden;';
    }
...
`
  ...
  const loaderWebflow = `(function(){window.__CB_WEBFLOW_MODE__=true;(function(){try{var _cbS=window.__CONSENT_SITE__||{};var _bt=(_cbS.bannerType||'gdpr').toLowerCase();var _cc=_bt==='\x63\x63\x70\x61';if(!_cc){window.dataLayer=window.dataLayer||[];window.gtag=window.gtag||function(){dataLayer.push(arguments);};window.gtag('\x63\x6f\x6e\x73\x65\x6e\x74','\x64\x65\x66\x61\x75\x6c\x74',{ad_storage:'\x64\x65\x6e\x69\x65\x64',analytics_storage:'\x64\x65\x6e\x69\x65\x64',ad_user_data:'\x64\x65\x6e\x69\x65\x64',ad_personalization:'\x64\x65\x6e\x69\x65\x64',functionality_storage:'\x64\x65\x6e\x69\x65\x64',personalization_storage:'\x64\x65\x6e\x69\x65\x64',security_storage:'\x67\x72\x61\x6e\x74\x65\x64',wait_for_update:500});}var _cats=null;var _dns=false;try{for(var _pi=0;_pi<localStorage.length;_pi++){var _pk=localStorage.key(_pi);if(_pk&&_pk.indexOf('\x63\x6f\x6e\x73\x65\x6e\x74\x62\x69\x74\x5f\x70\x72\x65\x66\x73\x5f')===0){try{var _pr=localStorage.getItem(_pk);if(_pr){_cats=JSON.parse(atob(_pr));break;}}catch(e){}}}}catch(e){}try{for(var _mi=0;_mi<localStorage.length;_mi++){var _mk=localStorage.key(_mi);if(_mk&&_mk.indexOf('\x63\x6f\x6e\x73\x65\x6e\x74\x62\x69\x74\x5f')===0&&_mk.indexOf('\x63\x6f\x6e\x73\x65\x6e\x74\x62\x69\x74\x5f\x70\x72\x65\x66\x73\x5f')!==0){try{var _md=JSON.parse(localStorage.getItem(_mk));if(_md&&_md.accepted){if(!_cats&&_md.categories)_cats=_md.categories;if(_md.ccpa&&_md.ccpa.doNotSell)_dns=true;break;}}catch(e){}}}}catch(e){}if(!_cc&&_cats){window.gtag&&window.gtag('\x63\x6f\x6e\x73\x65\x6e\x74','\x75\x70\x64\x61\x74\x65',{analytics_storage:_cats.analytics?'\x67\x72\x61\x6e\x74\x65\x64':'\x64\x65\x6e\x69\x65\x64',ad_storage:_cats.marketing?'\x67\x72\x61\x6e\x74\x65\x64':'\x64\x65\x6e\x69\x65\x64',ad_user_data:_cats.marketing?'\x67\x72\x61\x6e\x74\x65\x64':'\x64\x65\x6e\x69\x65\x64',ad_personalization:_cats.preferences?'\x67\x72\x61\x6e\x74\x65\x64':'\x64\x65\x6e\x69\x65\x64'});}var _blk=_cc?_dns:true;var _sbp=_cbS.scriptBlockProviders||[];var _ccr=_cbS.customCookieRules||[];function _ess(c){var lo=(c||'').trim().toLowerCase();return lo==='\x6e\x65\x63\x65\x73\x73\x61\x72\x79'||lo==='\x65\x73\x73\x65\x6e\x74\x69\x61\x6c';}function _mc(c){var lo=c.trim().toLowerCase();if(lo==='\x61\x64\x76\x65\x72\x74\x69\x73\x69\x6e\x67'||lo==='\x61\x64\x76\x65\x72\x74\x69\x73\x65\x6d\x65\x6e\x74')return'\x6d\x61\x72\x6b\x65\x74\x69\x6e\x67';if(lo==='\x66\x75\x6e\x63\x74\x69\x6f\x6e\x61\x6c'||lo==='\x70\x65\x72\x66\x6f\x72\x6d\x61\x6e\x63\x65')return'\x70\x72\x65\x66\x65\x72\x65\x6e\x63\x65\x73';return lo;}function _mp(src){if(!src)return false;for(var k=0;k<_sbp.length;k++){try{if(_sbp[k]&&_sbp[k].pattern&&new RegExp(_sbp[k].pattern,'\x69').test(src))return true;}catch(e){}}for(var l=0;l<_ccr.length;l++){try{if(_ccr[l]&&_ccr[l].scriptUrlPattern&&new RegExp(_ccr[l].scriptUrlPattern,'\x69').test(src))return true;}catch(e){}}return false;}function _jj(el){if(!_blk)return;if(!el||el.nodeName!=='\x53\x43\x52\x49\x50\x54')return;var src=(el.getAttribute&&el.getAttribute('\x73\x72\x63'))||'';if(src.indexOf('\x63\x6f\x6e\x73\x65\x6e\x74\x62\x69\x74')!==-1||src.indexOf('\x63\x6f\x6e\x73\x65\x6e\x74\x2e\x6a\x73')!==-1)return;if(el.type==='\x74\x65\x78\x74\x2f\x70\x6c\x61\x69\x6e')return;var dc=el.getAttribute&&el.getAttribute('\x64\x61\x74\x61\x2d\x63\x61\x74\x65\x67\x6f\x72\x79');if(dc){var cl=dc.split(',').map(function(c){return c.trim().toLowerCase();});if(cl.every(_ess))return;if(!_cc&&_cats){if(cl.every(function(c){return _ess(c)||!!_cats[_mc(c)];}))return;}if(src)el.setAttribute('\x64\x61\x74\x61\x2d\x63\x62\x2d\x62\x6c\x6f\x63\x6b\x65\x64\x2d\x73\x72\x63',src);el.type='\x74\x65\x78\x74\x2f\x70\x6c\x61\x69\x6e';}else if(src&&_mp(src)){if(!_cc&&_cats&&(_cats.analytics||_cats.marketing))return;el.setAttribute('\x64\x61\x74\x61\x2d\x63\x62\x2d\x62\x6c\x6f\x63\x6b\x65\x64\x2d\x73\x72\x63',src);el.type='\x74\x65\x78\x74\x2f\x70\x6c\x61\x69\x6e';}}var _ob=new MutationObserver(function(ms){ms.forEach(function(m){m.addedNodes.forEach(_jj);});});_ob.observe(document.documentElement,{childList:true,subtree:true});document.addEventListener('\x44\x4f\x4d\x43\x6f\x6e\x74\x65\x6e\x74\x4c\x6f\x61\x64\x65\x64',function(){_ob.disconnect();document.querySelectorAll('\x73\x63\x72\x69\x70\x74\x5b\x64\x61\x74\x61\x2d\x63\x61\x74\x65\x67\x6f\x72\x79\x5d,\x73\x63\x72\x69\x70\x74\x5b\x73\x72\x63\x5d').forEach(_jj);},{once:true});document.addEventListener('\x63\x6f\x6e\x73\x65\x6e\x74\x55\x70\x64\x61\x74\x65\x64',function(ev){var cats=(ev&&ev.detail)||{};if(_cc){var dns2=!!(cats.doNotSell||(cats.ccpa&&cats.ccpa.doNotSell));if(dns2&&!_blk){_blk=true;document.querySelectorAll('\x73\x63\x72\x69\x70\x74\x5b\x73\x72\x63\x5d').forEach(_jj);return;}if(!dns2)_blk=false;}var bl=document.querySelectorAll('script[type="\x74\x65\x78\x74\x2f\x70\x6c\x61\x69\x6e"][\x64\x61\x74\x61\x2d\x63\x62\x2d\x62\x6c\x6f\x63\x6b\x65\x64\x2d\x73\x72\x63]');for(var i=0;i<bl.length;i++){var s2=bl[i];var bsrc=s2.getAttribute('\x64\x61\x74\x61\x2d\x63\x62\x2d\x62\x6c\x6f\x63\x6b\x65\x64\x2d\x73\x72\x63')||'';if(!bsrc)continue;var dc2=s2.getAttribute('\x64\x61\x74\x61\x2d\x63\x61\x74\x65\x67\x6f\x72\x79')||'';var ok=false;if(_cc){if(cats.doNotSell===false)ok=true;else if(cats.doNotSell===true)ok=false;else ok=!!(cats.analytics||cats.marketing);}else if(dc2){var dca=dc2.split(',').map(function(x){return x.trim().toLowerCase();});ok=dca.every(function(x){if(x==='\x6e\x65\x63\x65\x73\x73\x61\x72\x79'||x==='\x65\x73\x73\x65\x6e\x74\x69\x61\x6c')return true;if(x==='\x61\x6e\x61\x6c\x79\x74\x69\x63\x73')return!!cats.analytics;if(x==='\x6d\x61\x72\x6b\x65\x74\x69\x6e\x67'||x==='\x61\x64\x76\x65\x72\x74\x69\x73\x69\x6e\x67'||x==='\x61\x64\x76\x65\x72\x74\x69\x73\x65\x6d\x65\x6e\x74')return!!cats.marketing;if(x==='\x70\x72\x65\x66\x65\x72\x65\x6e\x63\x65\x73'||x==='\x66\x75\x6e\x63\x74\x69\x6f\x6e\x61\x6c'||x==='\x70\x65\x72\x66\x6f\x72\x6d\x61\x6e\x63\x65')return!!cats.preferences;return true;});}else{ok=!!(cats.analytics||cats.marketing||cats.preferences);}if(ok){try{var ns2=document.createElement('\x73\x63\x72\x69\x70\x74');ns2.src=bsrc;if(s2.hasAttribute('\x61\x73\x79\x6e\x63'))ns2.async=true;if(s2.hasAttribute('\x64\x65\x66\x65\x72'))ns2.defer=true;var at2=s2.attributes;for(var ai=0;ai<at2.length;ai++){var an2=at2[ai].name;if(an2!=='\x73\x72\x63'&&an2!=='\x74\x79\x70\x65'&&an2!=='\x64\x61\x74\x61\x2d\x63\x62\x2d\x62\x6c\x6f\x63\x6b\x65\x64\x2d\x73\x72\x63')ns2.setAttribute(an2,at2[ai].value);}s2.parentNode&&s2.parentNode.replaceChild(ns2,s2);}catch(e){}}}});}catch(e){}})();var CONSENT_JS_SRC=${JSON.stringify(consentJsSrc)};if(!document.querySelector('\x73\x63\x72\x69\x70\x74\x5b\x73\x72\x63\x3d\x22'+CONSENT_JS_SRC+'\x22\x5d')){var _s=document.createElement('\x73\x63\x72\x69\x70\x74');_s.src=CONSENT_JS_SRC;_s.async=true;_s.setAttribute('\x64\x61\x74\x61\x2d\x64\x69\x73\x70\x6c\x61\x79\x2d\x6e\x61\x6d\x65','\x43\x6f\x6e\x73\x65\x6e\x74\x42\x69\x74\x53\x63\x72\x69\x70\x74\x32\x30\x32\x35');document.head.appendChild(_s);}})();
` + loader;

  const loaderIabWebflow = `(function(){window.__CB_WEBFLOW_MODE__=true;var CONSENT_JS_SRC=${JSON.stringify(consentJsSrc)};if(!document.querySelector('\x73\x63\x72\x69\x70\x74\x5b\x73\x72\x63\x3d\x22'+CONSENT_JS_SRC+'\x22\x5d')){var _s=document.createElement('\x73\x63\x72\x69\x70\x74');_s.src=CONSENT_JS_SRC;_s.async=true;_s.setAttribute('\x64\x61\x74\x61\x2d\x64\x69\x73\x70\x6c\x61\x79\x2d\x6e\x61\x6d\x65','\x43\x6f\x6e\x73\x65\x6e\x74\x42\x69\x74\x53\x63\x72\x69\x70\x74\x32\x30\x32\x35');document.head.appendChild(_s);}function _cbInstallTcfBridge(){if(!window.__tcfapi){setTimeout(_cbInstallTcfBridge,150);return;}try{window.__tcfapi('\x61\x64\x64\x45\x76\x65\x6e\x74\x4c\x69\x73\x74\x65\x6e\x65\x72',2,function(a,b){if(!b)return;if(a.eventStatus==='\x75\x73\x65\x72\x61\x63\x74\x69\x6f\x6e\x63\x6f\x6d\x70\x6c\x65\x74\x65'||a.eventStatus==='\x74\x63\x6c\x6f\x61\x64\x65\x64'){var c=!!(a.purpose&&a.purpose.consents&&a.purpose.consents[1]);var d={essential:true,analytics:c,marketing:c,preferences:c};window.userConsent=d;try{document.dispatchEvent(new CustomEvent('\x63\x6f\x6e\x73\x65\x6e\x74\x55\x70\x64\x61\x74\x65\x64',{detail:d,bubbles:true}));}catch(e){}}});}catch(e){}}_cbInstallTcfBridge();})();
` + loaderIab;
