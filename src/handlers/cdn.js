...
` + loaderIab;
  ...
  console.log('[CDN] SERVE | siteId:', resolvedSite.id, '| platform:', resolvedSite.platform || 'none', '| loader:', serveKind, '| plan:', effectivePlanId, '| domain:', resolvedSite.domain || 'none', '| bannerEnabled:', bannerEnabled);
