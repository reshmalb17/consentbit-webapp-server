window.__CONSENT_SITE__={"id":"9350eeac-7dbf-4b79-94d6-b669af7e097c","bannerType":"gdpr","bannerEnabled":true,"apiBase":"https://manager.consentbit.com","gaId":"","platform":"webflow","styles":"#cb-initial-banner.cb-banner{width:520px!important;min-width:360px;max-width:min(520px,96vw)!important;max-height:min(80vh,600px);overflow:hidden;background-color:#ffffff!important;color:#334155;position:fixed!important;bottom:32px!important;right:21px!important;left:auto!important;transform:none;padding:20px!important;border:1px solid #e2e8f0;border-radius:1.250rem!important;box-shadow:0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1);z-index:2147483647;display:flex;flex-direction:column;align-items:stretch;font-family:'Inter',ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:14px!important;line-height:1.5!important;font-weight:400;}#cb-initial-banner.cb-banner .cb-banner-body{flex:0 1 auto;min-width:0;min-height:0;overflow-y:auto;}#cb-initial-banner.cb-banner #cb-close-initial-btn,#cb-initial-banner.cb-banner [consentbit='close']{position:absolute!important;top:8px!important;right:20px!important;width:10px!important;height:10px!important;cursor:pointer!important;background:transparent!important;border:none!important;padding:0!important;z-index:10!important;display:none!important;}#cb-preferences-banner.cb-banner{width:600px;max-width:94vw;max-height:min(88vh,640px);min-height:0;overflow:hidden;background-color:#ffffff;color:#334155;position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);padding:28px;border:1px solid #e2e8f0;border-radius:1.250rem;box-shadow:0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1);z-index:2147483647;display:flex;flex-direction:column;font-family:'Inter',ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;font-size:14px!important;line-height:1.5!important;font-weight:400;}#cb-preferences-banner.cb-banner .cb-banner-body{flex:1 1 auto;min-height:0;overflow-y:auto;}.cb-banner h3{margin:0 0 8px;font-size:16px!important;line-height:1.4!important;font-weight:600;font-family:inherit;color:#0f172a;text-align:left!important;width:100%;}#cb-initial-banner.cb-banner h3,#cb-preferences-banner.cb-banner h3{font-weight:600!important;font-family:inherit!important;color:#0f172a;text-align:left!important;width:100%;}#cb-initial-banner.cb-banner .cb-banner-body h3,#cb-preferences-banner.cb-banner .cb-banner-body h3{padding-right:0!important;}.cb-gdpr-cat-label{color:#0f172a;}#cb-preferences-banner.cb-banner .cb-gdpr-cat-label ~ div > span{color:#334155!important;}.cb-banner p{margin:0 0 12px;font-size:14px!important;line-height:1.5!important;color:#334155;text-align:left!important;width:100%;}#cb-initial-banner.cb-banner .cb-banner-body > p,#cb-preferences-banner.cb-banner .cb-banner-body > p,#cb-preferences-banner.cb-banner .cb-gdpr-cat-desc{color:#334155;text-align:left!important;opacity:0.92;width:100%;}.cb-banner button{padding:6px 12px;border-radius:0.313rem;cursor:pointer;font-size:14px;font-weight:600;border:1px solid #e2e8f0;transition:opacity 0.2s;}.cb-banner button#cb-accept-all-btn{background-color:#007aff;color:#FFFFFF;border-color:#007aff;}.cb-banner button#cb-reject-all-btn{background-color:#007aff;color:#FFFFFF;border-color:#007aff;}.cb-banner button#cb-preferences-btn,.cb-banner button#cb-ccpa-donotsell-link{background-color:#ffffff;color:#0284c7;border-color:#e2e8f0;}.cb-banner button#cb-prefs-reject-btn{background-color:#007aff;color:#FFFFFF;border-color:#007aff;}#cb-preferences-banner.cb-ccpa-prefs .cb-banner-footer{display:flex!important;flex-direction:row!important;gap:10px!important;width:100%!important;}#cb-preferences-banner.cb-ccpa-prefs .cb-banner-footer button{flex:1 1 0!important;width:0!important;min-width:0!important;white-space:nowrap!important;}#cb-preferences-banner.cb-ccpa-prefs .cb-banner-footer button#cb-cancel-prefs-btn{background-color:#007aff;color:#FFFFFF;border-color:#007aff;}#cb-preferences-banner.cb-ccpa-prefs .cb-banner-footer button#cb-save-prefs-btn{background-color:#ffffff;color:#0284c7;border-color:#e2e8f0;}#cb-preferences-banner.cb-banner:not(.cb-ccpa-prefs) .cb-banner-footer button#cb-save-prefs-btn{background-color:#ffffff;color:#0284c7;border-color:#e2e8f0;}#cb-preferences-banner.cb-banner .cb-banner-footer button{padding:10px 36px!important;}#cb-initial-banner.cb-banner .cb-banner-footer{display:flex;flex-wrap:nowrap;gap:8px;justify-content:flex-start!important;flex-shrink:0;}#cb-initial-banner.cb-banner .cb-banner-footer button{flex:1 1 0;min-width:136px;white-space:nowrap;overflow:visible;text-overflow:clip;}#cb-initial-banner.cb-banner #cb-preferences-btn{background:#ffffff!important;color:#0284c7!important;border:1px solid #0284c7!important;font-size:13px!important;padding:10px 32px!important;font-weight:600!important;}#cb-initial-banner.cb-banner #cb-reject-all-btn{background:#007aff!important;color:#FFFFFF!important;border-color:#007aff!important;font-size:13px!important;padding:10px 32px!important;font-weight:600!important;}#cb-initial-banner.cb-banner #cb-accept-all-btn{background:#007aff!important;color:#FFFFFF!important;border-color:#007aff!important;font-size:13px!important;padding:10px 32px!important;font-weight:600!important;}.cb-gdpr-accordion{background-color:#ffffff;}.cb-banner-footer{display:flex;justify-content:flex-end;gap:10px;flex-wrap:wrap;}#cb-preferences-banner.cb-banner .cb-banner-footer{flex:0 0 auto;}","customization":{"position":"bottom-right","bannerLayoutVisual":"box","privacyPolicyUrl":null,"footerLink":false,"animationEnabled":true,"preferencePosition":"center","centerAnimationDirection":"fade-in","language":"en","autoDetectLanguage":false,"cookieExpirationDays":30,"backgroundColor":"#ffffff","textColor":"#334155","headingColor":"#0f172a","acceptButtonBg":"#007aff","acceptButtonText":"#FFFFFF","rejectButtonBg":"#007aff","rejectButtonText":"#FFFFFF","customiseButtonBg":"#ffffff","customiseButtonText":"#0284c7","saveButtonBg":"#ffffff","saveButtonText":"#0284c7","bannerEntranceAnimation":"fade-in","bannerFontWeight":"","bannerBorderRadius":"1.250rem","buttonBorderRadius":"0.313rem","textAlign":"left","showBannerLogo":true,"bannerLogoPosition":"left","font":"Inter","fontWeight":"400","fontSize":14,"textAlignment":"left","bannerBg2":"#798EFF","stopScroll":false},"floatingLogoUrl":"https://manager.consentbit.com/embed/floating-logo.svg","floatingLogoFallbackUrl":"https://manager.consentbit.com/embed/floating-logo.svg","scriptBlockProviders":[{"pattern":"google-analytics\\.com|googletagmanager\\.com/gtag/js|googletagmanager\\.com/gtm\\.js|region1\\.google-analytics\\.com","categories":["analytics"]},{"pattern":"googleadservices\\.com|googlesyndication\\.com|pagead/|google\\.com/pagead/|doubleclick\\.net|googleads\\.g\\.doubleclick\\.net","categories":["marketing"]},{"pattern":"connect\\.facebook\\.net|facebook\\.com/tr|pixel\\.facebook\\.com|fbevents\\.js","categories":["marketing"]},{"pattern":"bing\\.com|bat\\.bing\\.com|linkedin\\.com/px|snap\\.licdn\\.com","categories":["marketing"]},{"pattern":"analytics\\.tiktok\\.com|tiktok\\.com/i18n/pixel","categories":["marketing"]},{"pattern":"platform\\.twitter\\.com|twimg\\.com|t\\.co/1/i/adsct","categories":["marketing"]},{"pattern":"pintrk\\.js|ct\\.pinterest\\.com","categories":["marketing"]},{"pattern":"sc-static\\.net/scevent|tr\\.snapchat\\.com","categories":["marketing"]},{"pattern":"redditstatic\\.com/ads|reddit\\.com/api/v1/pixel","categories":["marketing"]},{"pattern":"amazon-adsystem\\.com|media\\.amazon\\.com|dsp\\.amazon|criteo\\.com|taboola\\.com|outbrain\\.com|widgets\\.outbrain\\.com","categories":["marketing"]},{"pattern":"hotjar\\.com|clarity\\.ms|fullstory\\.com|heap-analytics\\.com|cdn\\.heap|mixpanel\\.com|amplitude\\.com|segment\\.com|segment\\.io|cdn\\.segment|posthog\\.com|app\\.posthog","categories":["analytics","behavioral"]},{"pattern":"intercom\\.io|intercomcdn\\.com|drift\\.com|js\\.driftt\\.com|zendesk\\.com/embeddable|zdassets\\.com","categories":["marketing","preferences"]},{"pattern":"hubspot\\.com|hs-scripts\\.com|hsforms\\.com|marketo\\.com|mktoresp\\.com|pardot\\.com|go\\.pardot|list-manage\\.com|klaviyo\\.com|static\\.klaviyo","categories":["marketing"]},{"pattern":"player\\.vimeo\\.com|vimeo\\.com/api/player|wistia\\.com|fast\\.wistia","categories":["marketing"]},{"pattern":"spotify\\.com/embed|soundcloud\\.com/player","categories":["marketing"]},{"pattern":"yahoo\\.com|yimg\\.com|advertising\\.com|gemini\\.yahoo\\.com","categories":["marketing"]},{"pattern":"yandex\\.ru/metrika|mc\\.yandex|vk\\.com/js|top-fwz1\\.mail\\.ru","categories":["analytics","marketing"]},{"pattern":"omniture\\.com|adobedtm\\.com|demdex\\.net|tt.omtrdc\\.net|mbox\\.js","categories":["analytics","marketing"]},{"pattern":"quantcast\\.com|quantserve\\.com|liveramp\\.com|rlcdn\\.com|thetradedesk\\.com|adsrvr\\.org","categories":["marketing"]},{"pattern":"braze\\.com|sdk\\.braze|iterable\\.com|api\\.iterable","categories":["marketing"]},{"pattern":"newrelic\\.com|nr-data\\.net|datadoghq-browser-agent|datadoghq\\.com","categories":["analytics"]},{"pattern":"sentry\\.io|browser.sentry-cdn","categories":["analytics"]},{"pattern":"matomo\\.php|plausible\\.io|usefathom\\.com|cdn\\.usefathom","categories":["analytics"]},{"pattern":"static\\.cloudflareinsights\\.com|cloudflareinsights\\.com","categories":["analytics"]},{"pattern":"mouseflow\\.com|cdn\\.mouseflow|luckyorange\\.com|cdn\\.luckyorange|crazyegg\\.com|cdn\\.crazyegg|inspectlet\\.com|cdn\\.inspectlet","categories":["analytics","behavioral"]},{"pattern":"chartbeat\\.com|static\\.chartbeat|parsely\\.com|cdn\\.parsely|piano\\.io|tealiumiq\\.com|tags\\.tiqcdn|ensighten\\.com","categories":["analytics","marketing"]},{"pattern":"shopify\\.com/s/javascripts|monorail-edge\\.shopifysvc\\.com","categories":["marketing","analytics"]},{"pattern":"calendly\\.com/assets|assets\\.calendly|typeform\\.com|tally\\.so","categories":["preferences","marketing"]},{"pattern":"maps\\.googleapis\\.com/maps/api/js","categories":["preferences"]}],"customCookieRules":[],"pendingScan":false,"registeredDomain":"app-live-test.webflow.io"};
(function () {
...
! function () {
  ...
  if (t) {
    ...
    var TRANSLATIONS = {"config":{"bannerLayoutVisual":"box","bannerFontFamily":"Inter","bannerFontWeight":"400","bannerTextAlign":"left","bannerEntranceAnimation":"fade-in","bannerBg2":"#798EFF","bannerFontSize":14,"closeButtonEnabled":"0","rejectButtonEnabled":"1","customizeButtonEnabled":"1","cookiePolicyLinkEnabled":"0","floatingButtonEnabled":"1","floatingButtonPosition":"left"},"en":{"languageSelected":"en","title":"We value your privacy","description":"We use cookies to provide you with the best possible experience. They also allow us to analyze user behavior in order to constantly improve the website for you.","privacyPolicy":"Privacy Policy","acceptAll":"Accept","rejectAll":"Reject","customise":"Preference","save":"Save Preference","back":"Back","doNotSell":"Do Not Share My Personal Information","cookiePreferences":"Cookie Preferences","managePreferences":"By clicking, you agree to store cookies on your device to enhance navigation, analyze usage, and support marketing.","essential":"Strictly Necessary","strictlyNecessary":"","analytics":"Analytics","marketing":"Marketing","functional":"Functional","performance":"Performance","advertisement":"Advertisement","preferences":"Preferences","essentialDescription":"Essential cookies enable core site functions like security and accessibility. They don't store personal data and cant be disabled.","analyticsDescription":"These cookies collect anonymous data to help us improve website functionality and enhance user experience.","marketingDescription":"These cookies track users across websites to deliver relevant ads and may process personal data, requiring explicit consent.","preferencesDescription":"These cookies remember settings like language or region and store display preferences to offer a more personalized, seamless experience.","saveMyPreferences":"Save Preference","optOutPreference":"Opt-out Preference","ccpaDescription":"We use cookies to provide you with the best possible experience. They also allow us to analyze user behavior in order to constantly improve the website for you.","ccpaOptOut":"We use cookies and similar technologies to personalize and enhance your experience. Some of these technologies may involve the \"sale\" or \"sharing\" of your personal information under state privacy laws.","ccpaOptOutPreferenceIntro":"We use third-party cookies that help us analyze how you use this website, store your preferences, and provide the content and advertisements that are relevant to you. We do not sell your information. However, you can opt out of these cookies by checking Do Not Share My Personal Information and clicking the Save My Preferences button. Once you opt out, you can opt in again at any time by unchecking Do Not Share My Personal Information and clicking the Save My Preferences button.","limitUse":"Limit the use of my sensitive personal information","confirmChoice":"Confirm My Choice","cancel":"Cancel","alwaysOn":"always on","alwaysActive":"Always Active"}};
  ...
  function ze() {
    if (!document.getElementById("cb-styles")) {
      ...
      // No webfont is loaded here — the banner uses the system UI font stack.
      var _acceptBtnCss = "";
      if (l && l.acceptButtonBg) {
        var _abg = String(l.acceptButtonBg);
        var _atxt = l.acceptButtonText ? String(l.acceptButtonText) : "#ffffff";
        _acceptBtnCss = ".cb-banner button#cb-accept-all-btn{background-color:" + _abg + " !important;color:" + _atxt + " !important;border-color:" + _abg + " !important;}#cb-initial-banner.cb-banner #cb-accept-all-btn{background:" + _abg + " !important;color:" + _atxt + " !important;border-color:" + _abg + " !important;}"
      }
      var _rejectBtnCss = "";
      if (l && l.acceptButtonBg) {
