...
` + loaderIab;
  ...
  const serveKind = (wantsIab && iabAllowed && isWebflow) ? 'iabwebflow'
    ...
    : isWebflow ? 'webflow'
    : 'standard';
  console.log('[CDN1] banner selection — siteId:', resolvedSite.id,
