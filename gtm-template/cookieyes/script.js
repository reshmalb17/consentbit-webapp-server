!function() {
    var e = {
            ...
            "document"in window.self && ((!("classList"in document.createElement("_")) || document.createElementNS && !("classList"in document.createElementNS("http://www.w3.org/2000/svg", "g"))) && function(e) {
                ...
                if ("Element"in e) {
                    var t = "classList"
                      ...
                      , u = function(e) {
                        for (var t = i.call(e.getAttribute("class") || ""), o = t ? t.split(/\s+/) : [], r = 0, n = o.length; r < n; r++)
                            this.push(o[r]);
                    ...
                    ,
                    d.add = function() {
                        var e, t = arguments, o = 0, r = t.length, n = !1;
                        do {
                            -1 === c(this, e = t[o] + "") && (this.push(e),
                            n = !0)
                        } while (++o < r);
                    ...
                    ,
                    d.remove = function() {
                        var e, t, o = arguments, r = 0, n = o.length, i = !1;
                        do {
                            for (t = c(this, e = o[r] + ""); -1 !== t; )
                                this.splice(t, 1),
                                i = !0,
                                t = c(this, e)
                        } while (++r < n);
                    ...
                    n.defineProperty) {
                        ...
                        n[o].__defineGetter__ && r.__defineGetter__(t, l)
                }
            }(window.self),
            function() {
                "use strict";
        ...
        237: function() {
            ...
            function r(e, r) {
                ...
                t(r) ? (s.setRequestHeader("Content-Type", "text/plain;charset=UTF-8"),
                s.responseType = "text") : o(r) && r.type && s.setRequestHeader("Content-Type", r.type);
                try {
                    s.send(r)
                } catch (e) {
                    return !1
            ...
            function k(e, t) {
                return new Promise((function(o, i) {
                    ...
                    if (u.onload = function() {
                        ...
                        0 === s.url.indexOf("file://") && (u.status < 200 || u.status > 599) ? r.status = 200 : r.status = u.status,
                    ...
                    t && "object" == typeof t.headers && !(t.headers instanceof d || r.Headers && t.headers instanceof r.Headers)) {
                        var f = [];
    ...
    function() {
        if (!function() {
            try {
                const e = {
                    registeredDomain: "expanded-reassurance-279891.framer.app",
        ...
        if (!!(!window.cookieyes || !window.cookieyes._ckyStore)) {
            ...
            o._ckySetInStore = function(e, t) {
                ...
                r.push("lastRenewedDate:1779308725000"),
            ...
            n.consentid && parseInt(n.lastRenewedDate || 0) < parseInt("1779308725000") && (o._ckySetCookie("cookieyes-consent", "", 0),
            r["cookieyes-consent"] = "",
            o._ckySetCookie("euconsent", "", 0),
            n = {}),
            ...
            o._ckySendPageViewLog = function(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "";
                try {
                    const r = {
                      ...
                      , n = new FormData;
                    n.append("key", "040a441d4818e9d47ed2318bd7caaed6"),
                        ...
                        !function(e) {
                            try {
                                const t = o._ckyStartsWith(e.src, "//") ? `${window.location.protocol}${e.src}` : e.src
                                  , {hostname: r, pathname: n} = new URL(t)
                                  , i = `${r}${n}`.replace(/^www./, "");
                                if (function(e, t) {
                                    ...
                                    i.isOverriden = !0) : o._ckyStore._providersToBlock.push({
                                        url: t,
                                        categories: [n],
                                        fullPath: !1
                                    })
                                }(e, i),
                                !o._ckyShouldBlockProvider(i))
                                    return;
                                const s = o._ckyRandomString(8, !1);
                                if ("iframe" === e.nodeName.toLowerCase())
                                    !function(e, t) {
                                        let {offsetWidth: o, offsetHeight: r} = e;
                                        if (0 === o || 0 === r) {
                                            if (({offsetWidth: o, offsetHeight: r} = function(e) {
                                                let {width: t, height: o} = e.style;
                                                if (!t || !o) {
                                    ...
                                    o._ckyStore._bannerAttached && o._ckySetPlaceHolder && o._ckySetPlaceHolder(s);
                                else {
            ...
            i.src = "https://cdn-cookieyes.com/client_data/040a441d4818e9d47ed2318bd7caaed6/banner.js",
            i.async = !0,
